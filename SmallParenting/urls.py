...
from SmallParentingAPI.views import inicio, registro, EliminarHijo, chat_DIFICULTADES_DE_APRENDIZAJE, chat_PRESION_ACADEMICA, cerrar_sesion, C_Disruptiva, D_Autoridad, Bullying, agregar_hijo
...
urlpatterns = [
    ...
    path('EliminarHijo/', EliminarHijo, name='EliminarHijo'),
